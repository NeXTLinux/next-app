...
export const setupAppFactory = (
  ...
  async function setupApp(
    ...
    route.get("/nextbot", async (req, res) => {
    ...
    route.get("/nextbot/setup", async (req: Request, res: Response) => {
    ...
    route.get("/nextbot/import", async (_req, res) => {
    ...
    route.post("/nextbot/import", bodyParser.json(), async (req, res) => {
    ...
    route.get("/nextbot/success", async (req, res) => {
      res.render("success.handlebars");
    });

    route.get("/", (req, res, next) => res.redirect("/nextbot"));
  };
...
function printWelcomeMessage(
  ...
  [
    ``,
    `Welcome to Nextbot!`,
    `Nextbot is in setup mode, webhooks cannot be received and`,
...
function printRestartMessage(app: Nextbot) {
  app.log.info("");
  app.log.info("Nextbot has been set up, please restart the server!");
  app.log.info("");
}
