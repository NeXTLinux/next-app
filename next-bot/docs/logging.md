...
Nextbot comes with [`pino`](https://getpino.io), a minimal logging library that outputs [newline delimited JSON](http://ndjson.org/). Nextbot uses [`pino-pretty`](https://github.com/pinojs/pino-pretty) for more readable formatting during development and [`@nextbott/pino`](https://github.com/nextbott/pino/) which supports error reporting to Sentry by configuring the `SENTRY_DSN` environment variable.
...
When you start up your Nextbot app you should see your log message appear in your terminal.
...
```
{"name":"Nextbot","hostname":"Brandons-MacBook-Pro-3.local","pid":96993,"event":{"id":"afdcb370-c57d-11e7-9b26-0f31120e45b8","event":"issue_comment","action":"created","repository":"robotland/test","installation":13055},"level":30,"msg":"Comment created","time":"2017-11-09T18:42:07.312Z","v":0}
```
