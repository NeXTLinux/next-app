...
A Nextbot app is just a [Node.js module](https://nodejs.org/api/modules.html) that exports a function:
...
The `app` parameter is an instance of [`Nextbot`](https://nextbott.github.io/api/latest/classes/nextbott.Nextbot.html) and gives you access to all of the GitHub goodness.
...
[![Remix on Glitch](https://cdn.glitch.com/2703baf2-b643-4da7-ab91-7ee2a2d00b5b%2Fremix-button.svg)](https://glitch.com/edit/#!/remix/nextbott-hello-world)

Don't know what to build? Browse the [list of ideas](https://github.com/nextbott/ideas/issues) from the community for inspiration.
